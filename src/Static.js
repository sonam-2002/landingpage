...
export const footerData = {
    brand: {
      ...
      copyright: "© 2022 Ed-Circle. All rights reserved.",
    },
    
    links: [
      {
        title: "Product",
        items: ["Overview", "Features", "Solutions", "Tutorials", "Pricing"],
      },
      {
        title: "Company",
      ...
      {
        title: "Social",
        items: ["Twitter", "LinkedIn", "GitHub", "Dribbble"],
      },
      {
        title: "Legal",
        items: ["Terms", "Privacy", "Cookies", "Contact"],
      },
    ],
  };
